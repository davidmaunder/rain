<svg style="display:none;" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 100 60" style="enable-background:new 0 0 100 60;" xml:space="preserve">
	<symbol id="rain-logo-footer">
...
<footer>
		...
		<div class="container-fluid">
			<div class="col-md-7 locations">
				<h2 class="phone-number">
					<svg class="icon-phone" viewBox="0 0 200 200"><use xlink:href="#phone"></use></svg>
					<a href="tel:+441909771100">01909 771100</a>
				</h2>
				<h2 class="phone-number">
					<svg class="icon-phone" viewBox="0 0 200 200"><use xlink:href="#clock"></use></svg>
					Mon - Sun 9:00am to 5:00pm
				</h2>
				<h3 class="location-list">Providing Gas Services for Sheffield and the surrounding&nbsp;areas</h3>
				<p class="location-list">Aston, Aughton, Barlborough, Barsnley, Beighton, Carlton in Lindrick, Chesterfield, Clowne, Cresswell, Dinnington, Doncaster, Eckington, Harthill, Killamarsh, Kiveton Park, Maltby, Mosborough, North Anston, Owlthorpe, Rotherham, South Anston, Swallownest, Thurcroft, Tickhill, Todwick, Whitwell, Wickersley, Worksop</p>
			</div>
			<div class="col-md-5 logos">
				<a href="http://www.oftec.org.uk/" target="_blank">
					<svg class="icon-medium" viewBox="0 0 136.7 146.1"><use xlink:href="#oftec"></use></svg>
					<p>C4045</p>
				</a>
				<a href="http://www.gassaferegister.co.uk/about/the_gas_safe_register_scheme.aspx" target="_blank">
					<svg class="icon-medium" viewBox="0 0 284 307.3"><use xlink:href="#gas-safe"></use></svg>
					<p>201317</p>
				</a>
			</div>
		</div>
	...
	<section class="credit">
		<div class="container-fluid">
			<p class="col-md-12">Rain Creative is a design and digital studio&nbsp;based&nbsp;in&nbsp;Manchester.</p>
			<p class="col-md-12">Copyright © <script>document.write(new Date().getFullYear())</script> Rain Creative Ltd. Registered in England&nbsp;and&nbsp;Wales&nbsp;No.10262683</p>
			<div class="col-md-12">
				<svg class="rain-footer" viewBox="0 0 100 60"><use xlink:href="#rain-logo"></use></svg>
			</div>
		</div>
	</section>
</footer>
